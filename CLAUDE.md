...
- Do not edit files owned by other agents (Agent B: `backend/app/api/v1/lms/*`, Agent C: `backend/app/api/v1/platform/*` + `admin/**` + `frontend/**`, Agent D: `db/**` + `backend/alembic/**` + `keycloak/**`).
